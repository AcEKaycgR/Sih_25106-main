...
import {Activity, Users, DollarSign, Goal} from 'lucide-react';
import {PlacementCharts} from '@/components/mentor/placement-charts';
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Shared by mentors</p>
          </CardContent>
        </Card>
      </div>
      <div>
